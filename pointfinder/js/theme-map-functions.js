					...
					events:{
					  click: function(marker, event, context){
					  		if($.pf_mobile_check()){
								...
								$.pfloadinfowindow_top(marker, '', context.data.id,map,wbi,hbi);
							}
					  },
					},
					callback: function(){
						...
						if($.pf_mobile_check()){
							setTimeout(function(){$.pfloadinfowindow_top(marker, '', singlepoint,map,wbi,hbi);},1000);
						}
