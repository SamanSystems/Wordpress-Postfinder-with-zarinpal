...
***************************************************************************************************************/
	...
	$('.pfbuttonpaymentb').live('click',function(){
		...
		}else if(selectedval == 'zaringate'){

			$.pfOpenPaymentModal('open','zaringate',itemnum,'');

		}else if(selectedval == 'zarinweb'){

			$.pfOpenPaymentModal('open','zarinweb',itemnum,'');
