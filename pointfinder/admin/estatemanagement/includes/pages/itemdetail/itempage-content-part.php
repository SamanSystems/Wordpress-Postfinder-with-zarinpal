...
**/
	function pfitempage_fimage_block(){
		...
		$featured_image_output = '<img src="'.$featured_image[0].'" alt="'.get_the_title().'" class="itp-featured-img"/>';
...
**/
	...
	function pf_itemdetail_thirdcol($content1,$content2){
		$return_val = '';
		$return_val .= '<div class="pf-container"><div class="pf-row"><div class="col-lg-3">';
			$return_val .= $content1;
		$return_val .= '</div>';
	...
	function pf_itemdetail_thirdcolx($content1,$content2){
		$return_val = '';
		$return_val .= '<div class="pf-container"><div class="pf-row"><div class="col-lg-9">';
			$return_val .= $content1;
		$return_val .= '</div>';
		$return_val .= '<div class="col-lg-3 pf-offsetarea">';
			$return_val .= $content2;
		$return_val .= '</div></div></div>';
		return $return_val;
	}
