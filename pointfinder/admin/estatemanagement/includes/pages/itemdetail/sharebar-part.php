...
?>
		<ul class="pf-sharebar-icons clearfix">
			...
			<li><a href="http://pinterest.com/pin/create/bookmarklet/?media={$item_thumnail2}&url=<?php echo $item_permalink;?>&description=<?php echo $item_title;?>" onclick="window.open(this.href,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=640,height=480')" class="pfsharebar-pinterest info-tip2" aria-describedby="helptooltip"><span class="pftooltipx" role="tooltip"><?php echo esc_html__('Share','pointfindert2d');?></span><span class="pfadmicon-glyph-810"></span></a></li>
		</ul>
<?php
