        ...
        if ( $user_exist || $user_email_exist ) {
            ...
            if ( $message_reply) {
                ...
                */
                ...
                $message = esc_html__("Um, it looks like there was any error and we failed to receive your request ... if this problem persists please let us know!","pointfindert2d");
