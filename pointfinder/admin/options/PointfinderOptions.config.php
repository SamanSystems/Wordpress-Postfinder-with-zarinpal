				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						/*
						array(
							'id' => 'general_viewoptions',
							'type' => 'button_set',
							'title' => esc_html__('View Option', 'pointfindert2d') ,
							'options' => array(
								'1' => esc_html__('Wide', 'pointfindert2d') ,
								'0' => esc_html__('Box', 'pointfindert2d')
							) , 
							'default' => '1',
						) ,
						*/
				...
				$this->sections[] = array(
					...
					'fields' => array(
						array(
							...
							'theme' => 'chrome',
							'hint' => array(
								'content' => esc_html__('Please copy & paste your google analytic code without script tags.', 'pointfindert2d')
							)
						) 
					) ,
				);
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
							...
							/*
							array(
		                        'id'            => 'setup18_headerbarsettings_padding_menu',
		                        'type'          => 'spacing',
		                        'mode'          => 'margin', 
		                        'all'			=> false,  
		                        'right'         => false,
		                        ...
		                        'units_extended'=> 'false',
		                        'display_units' => 'true',
		                        'title'         => esc_html__('Menu Top Margin', 'pointfindert2d'),
		                        'default'       => array(
		                            'margin-top'    => '32px', 
		                        )
		                    ),
			...
			**/
				...
				$this->sections[] = array(
					...
					'fields' => array(
						array(
	                        ...
	                        'subtitle'  => '<small><strong>'.esc_html__('Profile Page Content :','pointfindert2d') .'</strong></small><small>'.esc_html__('You can add a content page & set the position of it by using below options.', 'pointfindert2d').'</small>',
	                        'indent'    => true, 
	                    ),
	                    	array(
	                    ...
	                    array(
	                        ...
	                        'subtitle'  => '<small><strong>'.esc_html__('Submit Item Page Content :','pointfindert2d').'</strong></small><small>'.esc_html__('You can add a content page & set the position of it by using below options.', 'pointfindert2d').'</small>',
	                        'indent'    => true, 
	                    ),
	                    	array(
							...
							array(
		                        'id'        => 'setup29_dashboard_contents_submit_page_layout',
		                        'type'      => 'image_select',
		                        'title'     => esc_html__('Page Layout', 'pointfindert2d'),
	                    ...
	                    array(
	                        ...
	                        'subtitle'  => '<small><strong>'.esc_html__('My Items Page Content :','pointfindert2d').'</strong></small><small>'.esc_html__('You can add a content page & set the position of it by using below options.', 'pointfindert2d').'</small>',
	                        'indent'    => true, 
	                    ),
	                    	array(
							...
							array(
		                        'id'        => 'setup29_dashboard_contents_my_page_layout',
		                        'type'      => 'image_select',
		                        'title'     => esc_html__('Page Layout', 'pointfindert2d'),
	                    ...
	                    array(
	                        ...
	                        'subtitle'  => '<small><strong>'.esc_html__('Favorites Page Content :','pointfindert2d').'</strong></small><small>'.esc_html__('You can add a content page & set the position of it by using below options.', 'pointfindert2d').'</small>',
	                        'indent'    => true, 
	                    ),
	                    	array(
							...
							array(
		                        'id'        => 'setup29_dashboard_contents_favs_page_layout',
		                        'type'      => 'image_select',
		                        'title'     => esc_html__('Page Layout', 'pointfindert2d'),
	                    ...
	                    array(
	                        ...
	                        'subtitle'  => '<small><strong>'.esc_html__('My Reviews Page Content :','pointfindert2d').'</strong></small><small>'.esc_html__('You can add a content page & set the position of it by using below options.', 'pointfindert2d').'</small>',
	                        'indent'    => true, 
	                    ),
	                    	array(
							...
							array(
		                        'id'        => 'setup29_dashboard_contents_rev_page_layout',
		                        'type'      => 'image_select',
		                        'title'     => esc_html__('Page Layout', 'pointfindert2d'),
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
	                        'id'        => 'setup4_submitpage_descriptiontip',
	                        'type'      => 'textarea',
	                        'title'     => esc_html__('Description Textarea Tooltip', 'pointfindert2d'),
	                        'subtitle'  => '<strong>'.esc_html__('OPTIONAL :','pointfindert2d').' </strong>'.sprintf(esc_html__('You can add a tooltip on %s field.', 'pointfindert2d'),'Description'),
	                        'validate'  => 'no_html',
						...
						array(
		                        'id'        => 'setup4_submitpage_minres',
		                        'type'      => 'spinner',
		                        'title'     => esc_html__('Minimum Result Number for Search', 'pointfindert2d'),
		                        'default'   => '10',
		                        'min'       => '0',
		                        'step'      => '1',
		                        'max'       => '40',
						...
						array(
							...
							array(
								'id' => 'setup4_submitpage_listingtypes_group',
								'type' => 'button_set',
							...
							array(
								'id' => 'setup4_submitpage_listingtypes_group_ex',
								'type' => 'button_set',
								...
								'required'	=> array('setup4_submitpage_listingtypes_group','=','1'),
								'default' => '1'
							...
							array(
								'id' => 'setup4_submitpage_listingtypes_gridview',
								'type' => 'button_set',
								'title' => esc_html__('Selectbox Grid View', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Enable', 'pointfindert2d') ,
									'0' => esc_html__('Disable', 'pointfindert2d')
								),
								'desc' => esc_html__('If it is enabled, you will see 4 column grid in the listing type select box.', 'pointfindert2d') ,
								'default' => '0'
	                    ...
	                    array(
							...
							array(
								'id' => 'setup4_submitpage_itemtypes_help',
								'type' => 'info',
								'notice' => true,
								'style' => 'info',
	                    ...
	                    array(
							...
							array(
								...
								'desc' => esc_html__('If it is enabled, you will see the main group name into the list with select all option.', 'pointfindert2d') ,
								'required'	=> array('setup4_submitpage_locationtypes_group','=','1'),
								'default' => '1'
							...
							array(
								'id' => 'setup4_submitpage_locationtypes_help',
								'type' => 'info',
								'notice' => true,
								'style' => 'info',
								'desc' => esc_html__('This post type currently disabled by Post Type Setup', 'pointfindert2d'),
	                    ...
	                    array(
							...
							array(
								'id' => 'setup4_submitpage_featurestypes_help',
								'type' => 'info',
								'notice' => true,
								'style' => 'info',
								'desc' => esc_html__('This post type currently disabled by Post Type Setup', 'pointfindert2d'),
				...
				**/
				$this->sections[] = array(
					...
					'subsection' => true,
					'title' => esc_html__('Upload Settings', 'pointfindert2d') ,
					'fields' => array(
							array(
		                        'id'        => 'setup31_userpayments_priceperitem',
		                        'type'      => 'spinner',
		                        'title'     => esc_html__('Price for Per Item Submission', 'pointfindert2d'),
		                        'desc'		=> esc_html__('Write 0 for free. You can define price sign and currency from Zarinpal Settings.', 'pointfindert2d'),
		                        'default'   => '10',
		                        'min'       => '0',
		                        'step'      => '1',
		                        'max'       => '100000',
		                    ...
		                    array(
		                        ...
		                        'type'      => 'spinner',
		                        'title'     => esc_html__('Time for Item Submission', 'pointfindert2d'),
		                    ...
		                    array(
								...
								'type' => 'button_set',
								'title' => esc_html__('Recurring Payments', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Enable', 'pointfindert2d') ,
									'0' => esc_html__('Disable', 'pointfindert2d')
								) ,
							...
							array(
								'id' => 'setup31_userpayments_recurringitem',
								'type' => 'button_set',
								'title' => esc_html__('Recurring Payment Checkbox', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Checked', 'pointfindert2d') ,
									'0' => esc_html__('Unchecked', 'pointfindert2d')
								) ,
								'hint'      => array(
	                        		'content' => esc_html__('Do you want to show recurring payment checkbox checked or unchecked?', 'pointfindert2d')
	                        	),
	                        	'required'	=> array('setup31_userpayments_recurringoption','=','1'),
								'default' => '1'
							) ,
							...
							array(
			                    'id'        => 'setup31_userpayments_recurringoption_bg',
			                    'type'      => 'color',
			                    'transparent' => false,
			                    'compiler'	=> array('.pfuaformsidebar .pf-sidebar-cartitems .pfrecitemdescription'),
			                    'mode'      => 'background',
			                    'title'     => esc_html__('Recurring Payment Box: BG Color', 'pointfindert2d'),
			                    'default'   => '#fae7a2',
			                    'validate'  => 'color',
			                    'required'	=> array('setup31_userpayments_recurringoption','=',1)
			                ),
			                array(
			                    'id'        => 'setup31_userpayments_recurringoption_text',
			                    'type'      => 'color',
			                    'compiler'	=> array('.pfuaformsidebar .pf-sidebar-cartitems .pfrecitemdescription', '.pfuaformsidebar .pf-sidebar-cartitems .pfrecitemdescription label'),
			                    'transparent' => false,
			                    'title'     => esc_html__('Recurring Payment Box : Text Color', 'pointfindert2d'),
			                    'default'   => '#494949',
			                    'validate'  => 'color',
			                    'required'	=> array('setup31_userpayments_recurringoption','=',1)
			                ),
							array(
								'id' => 'setup31_userpayments_help2',
								'type' => 'info',
								'notice' => true,
								'style' => 'info',
							...
							array(
		                        ...
		                        'desc'		=> esc_html__('This is the waiting period for pending payment. Item will be removed after waiting period runs out. Please set variable 0 to disable.', 'pointfindert2d'),
		                        'default'   => '10',
		                        'min'       => '0',
		                        'step'      => '1',
		                        'max'       => '1000000',
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
							...
							array(
								'id' => 'setup31_userlimits_useredit_pendingapproval',
								'type' => 'button_set',
								'title' => esc_html__('Can user edit pending approval items?', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Yes', 'pointfindert2d') ,
									'0' => esc_html__('No', 'pointfindert2d')
								) ,
					...
					'fields' => array(
							...
							array(
			                    ...
			                    array(
			                        ...
			                        'desc'		=> esc_html__('Write 0 for free. You can define price sign and currency on Zarinpal Settings.', 'pointfindert2d'),
			                        'default'   => '5',
			                        'min'       => '0',
			                        'step'      => '1',
			                        'max'       => '10000000',
				...
				**/
				$this->sections[] = array(
					...
					'subsection' => true,
					'title' => esc_html__('Zarinpal Settings', 'pointfindert2d'),
					'fields' => array(
							array(
								'id' => 'setup20_paypalsettings_paypal_status',
								'type' => 'button_set',
								'title' => esc_html__('Zarinpal Payment System', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Enable', 'pointfindert2d') ,
									'0' => esc_html__('Disable', 'pointfindert2d')
								) ,
							...
							array(
								...
								'desc' => esc_html__('برای استفاده از زرین وب این گزینه را غیر فعال و برای زرین گیت این گزینه را فعال نمایید.', 'pointfindert2d') ,
								'type' => 'button_set',
								'title' => esc_html__('Enable ZarinGate', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Enable', 'pointfindert2d') ,
									'0' => esc_html__('Disable', 'pointfindert2d')
								) ,
							...
							array(
								...
								'desc' => esc_html__('If this option is enabled: Pointfinder will only accept payments from verified Zarinpal Users', 'pointfindert2d') ,
								'type' => 'button_set',
							...
							array(
		                        ...
		                        'type'      => 'text',
		                        'title'     => esc_html__('Zarinpal Price Unit', 'pointfindert2d'),
		                        'default'	=> 'USD',
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1'),
		                    ...
		                    array(
		                        ...
		                        'type'      => 'text',
		                        'title'     => esc_html__('Zarinpal Price Sign', 'pointfindert2d'),
		                        'default'	=> '$',
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1')
		                    ),
							array(
		                        ...
		                        'type'      => 'text',
		                        'title'     => esc_html__('Zarinpal API User', 'pointfindert2d'),
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1')
		                    ),
		                    ...
		                    array(
		                        ...
		                        'type'      => 'text',
		                        'title'     => esc_html__('Zarinpal Title', 'pointfindert2d'),
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1'),
		                        'default'	=> esc_html__('PointFinder Payment:','pointfindert2d')
		                    ),
		                    array(
		                        'id'        => 'setup20_paypalsettings_paypal_api_packagename_basic',
		                        'type'      => 'text',
		                        'title'     => esc_html__('Listing Pack Description ', 'pointfindert2d'),
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1'),
		                        'default'	=> esc_html__('Basic Listing Payment','pointfindert2d')
		                    ),
		                    array(
		                        'id'        => 'setup20_paypalsettings_paypal_api_packagename_featured',
		                        'type'      => 'text',
		                        'title'     => esc_html__('Featured Pack Description', 'pointfindert2d'),
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1'),
		                        'default'	=> esc_html__('Featured Listing Payment','pointfindert2d')
		                    ),
		                    array(
		                        ...
		                        'style'     => 'info',
		                        'required' => array('setup20_paypalsettings_paypal_status','=','1'),
		                        'desc'      => esc_html__('Below settings will affect price value which is used in cart and paypal.', 'pointfindert2d')
		                    ),
		                    array(
				...
				$this->sections[] = array(
					...
					'fields' => array(
							array(
		                        ...
		                        'required' => array('setup4_membersettings_loginregister','=','0')
		                    ),
							array(
								...
								'default' => '1',
								'required' => array('setup4_membersettings_loginregister','=','1')
							) ,
							array(
							...
							array(
		                        ...
		                        'required' => array(
		                        	...
		                        	array('setup4_membersettings_loginregister','=','1')
		                        )
		                    ),
		                    array(
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'setup3_pointposttype_help',
							'type' => 'info',
							'notice' => true,
							'style' => 'critical',
							'title' => esc_html__('IMPORTANT NOTICE', 'pointfindert2d'),
							'desc' => esc_html__('Please configure these sections before you use theme. If you change configuration after using theme, data which is related to these sections will be lost.', 'pointfindert2d').'<br/ >'.esc_html__('You may need to flush the rewrite rules after changing this. You can do it manually by going to the Permalink Settings page and re-saving the rules', 'pointfindert2d')
						) ,
						array(
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'setup15_mapnotifications_help3',
							'type' => 'info',
							'notice' => true,
							'style' => 'info',
						...
						array(
							'id' => 'setup15_mapnotifications_help2',
							'type' => 'info',
							'notice' => true,
							'style' => 'info',
			...
			**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'setup14_multiplepointsettings_help',
							'type' => 'info',
							'notice' => true,
							'style' => 'info',
			...
			**/	
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
								array(
									'id' => 'setup42_itempagedetails_report_help',
									'type' => 'info',
									'notice' => true,
									'style' => 'critical',
									'title' => esc_html__('IMPORTANT NOTICE', 'pointfindert2d') ,
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
								array(
									'id' => 'setup42_itempagedetails_claim_help',
									'type' => 'info',
									'notice' => true,
									'style' => 'critical',
									'title' => esc_html__('IMPORTANT NOTICE', 'pointfindert2d') ,
			...
			**/	
				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'setup42_searchpagemap_help1',
							'type' => 'info',
							'notice' => true,
							'style' => 'info',
							'required' => array('setup42_searchpagemap_headeritem','=','1'),
				...
				$this->sections[] = array(
					...
					'fields' => array(
						array(
			                ...
			                'type'  => 'info',
			                'style' => 'info',
			                'title' => __( 'Auto Update System', 'redux-framework-demo' ),
			                'desc'  => __( 'You can get auto updates for Point Finder from Envato. if below fields filled correctly.', 'redux-framework-demo' )
			            ),
						array(
