                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'compiler' => array('.pfrevstars-wrapper-review') ,
                            'mode' => 'background',
                            'validate' => 'colorrgba',
                            'transparent' => false,
                        ) ,
                        ...
                        array(
                            ...
                            'desc' => esc_html__('If this enabled, Review Band & Stars will be hidden for all items.', 'pointfindert2d') ,
                        ),
                        ...
                        array(
                            ...
                            'default' => 1,
                            'options' => array(
                                '0' => esc_html__('Show Not Rated Text', 'pointfindert2d') ,
                                '1' => esc_html__('Show Nothing', 'pointfindert2d')
                            ),
                            'desc' => esc_html__('If this enabled, Review Band & Stars will be hidden for all items.', 'pointfindert2d') ,
                        ),
                        array(
                            'id' => 'setup16_reviewstars_revtextbefore',
                            'type' => 'text',
                            'title' => esc_html__('Review Band Text', 'pointfindert2d'),
                            'default' => esc_html__('Rating :','pointfindert2d')
                        ) ,
                    )
                );
            /**
