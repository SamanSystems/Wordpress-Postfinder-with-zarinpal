				...
				**/
					...
					**/
						$this->sections[] = array(
							...
							'subsection' => true,
							'title' => sprintf(esc_html__('Payment System (%s)', 'pointfindert2d'),esc_html__('User','pointfindert2d')),
							'heading' => sprintf(esc_html__('Payment System: %s Notifications', 'pointfindert2d'),esc_html__('User','pointfindert2d')),
							'fields' => array(
									/**
					...
					**/
						$this->sections[] = array(
							...
							'subsection' => true,
							'title' => sprintf(esc_html__('Payment System (%s)', 'pointfindert2d'),esc_html__('Admin','pointfindert2d')),
							'heading' => sprintf(esc_html__('Payment System: %s Notifications', 'pointfindert2d'),esc_html__('Admin','pointfindert2d')),
							'fields' => array(
					                /**
					...
					**/
						$this->sections[] = array(
							...
							'subsection' => true,
							'title' => esc_html__('Auto System (Expiry)', 'pointfindert2d'),
							'fields' => array(
					                /**
