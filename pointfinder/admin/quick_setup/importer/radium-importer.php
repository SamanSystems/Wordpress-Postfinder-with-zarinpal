  ...
  */
  ...
  public $flag_as_imported = array();
    ...
    public function add_admin() {
        ...
        add_submenu_page('pointfinder_tools', '', esc_html__("Quick Setup","pointfindert2d"), 'switch_themes', 'pointfinder_demo_installer', array($this, 'pfd_demo_installer'));
    ...
    public function pfd_demo_installer() {
        ...
        <div class="wrap about-wrap">
          ...
          if ( is_plugin_active('redux-framework/redux-framework.php') ) {
            ...
            ?>
              <div style="margin:20px 0;padding: 0;color: #494949; width:100%; line-height:18px;font-size:13px"><p class="tie_message_hint">
              <?php echo esc_html__('This setup was already run before.','pointfindert2d');?>
              </p></div>
            <?php
            }else{
            ?>
              ...
              <div class="changelog headline-feature">
                ...
                <table class="form-table">
                  ...
                  <tr>
                    ...
                    <div class="pfclloading" style="background-size: 24px 24px!important;background-repeat: no-repeat!important;background-position: right!important;width: 24px;height: 24px;display: inline-block;margin-left: 20px;vertical-align: middle;"></div>
