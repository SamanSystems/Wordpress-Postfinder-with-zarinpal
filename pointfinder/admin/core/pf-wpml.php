				...
				**/
					echo '<key name="pfitemreviewsystem_options">';
						echo '<key name="setup11_reviewsystem_criterias">'.PHP_EOL;
								...
								$pfstart = PFCheckStatusofVar('setup11_reviewsystem_criterias');
								if($pfstart){
									for ($i=0; $i < (count($setup11_reviewsystem_criterias) - 1) ; $i++) { 
				...
				**/
					echo '<key name="pointfindertheme_options">';
						...
						/* Submission System */
				            ...
				            <key name="setup20_paypalsettings_paypal_api_packagename_basic" />
				            <key name="setup20_paypalsettings_paypal_api_packagename_featured" />
