              ...
              <?php 
                ...
                if(is_array($setup1s_slides)){
                    ...
                    **/
                    ...
                    if (!empty($current_post_id) && (is_single() || is_category() || is_archive())) {
                    ...
                    echo '<input type="hidden" name="_wpnonce" value="'.wp_create_nonce( 'search-widget' ).'"/>';
                    ...
                    (function($) {
                        ...
                        if ($fltf != 'none') {
                            ...
                            $("#'.$fltf.'" ).on("change", function(e) {
                              $.PFGetSubItems(e.val,"'.base64_encode($pfformvars_json).'",1,0);
                            });
