...
*
***********************************************************************************************************************************/
function pf_deregister_vc_scripts(){
	/* Pretty photo*/
	if(wp_script_is('prettyphoto', 'registered')){wp_dequeue_script('prettyphoto');wp_deregister_script('prettyphoto');};
	if(wp_style_is('prettyphoto', 'registered')){wp_dequeue_style('prettyphoto');wp_deregister_style('prettyphoto');};
	/* Nivo Slider */
	if(wp_script_is('nivo-slider', 'registered')){wp_dequeue_script('nivo-slider');wp_deregister_script('nivo-slider');};
	if(wp_style_is('nivo-slider-css', 'registered')){wp_dequeue_style('nivo-slider-css');wp_deregister_style('nivo-slider-css');};
	if(wp_style_is('nivo-slider-theme', 'registered')){wp_dequeue_style('nivo-slider-theme');wp_deregister_style('nivo-slider-theme');};
	/*Flex Slider*/
	if(wp_script_is('flexslider', 'registered')){wp_dequeue_script('flexslider');wp_deregister_script('flexslider');};
	if(wp_style_is('flexslider', 'registered')){wp_dequeue_style('flexslider');wp_deregister_style('flexslider');};
	
}
add_action('wp_head','pf_deregister_vc_scripts',0);
