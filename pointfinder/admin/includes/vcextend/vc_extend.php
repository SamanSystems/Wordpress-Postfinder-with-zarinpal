...
if(is_admin()){	
	...
	*/
	...
	function vc_extend_notice() {
	  ...
	  echo '
	  <div class="updated">
		<p>'.sprintf(esc_attr__('%s requires %s Visual Composer %s plugin to be installed and activated on your site.', 'pointfindert2d'), '<strong>'.$plugin_data['Name'].'</strong>','<strong><a href="http://bit.ly/vcomposer" target="_blank">','</a></strong>').'</p>
	  </div>';
	}
		...
		**/
			...
			array_push($PFVEXFields_ItemGrid['params'],
				...
				array(
					  ...
					  "param_name" => "cols",
					  "value" => array('2 Columns'=>'2','3 Columns'=>'3','4 Columns'=>'4'),
				...
				array(
					  ...
					  "description" => esc_html__("Disable featured items and show another items on query.", "pointfindert2d"),
					  "value" => array(esc_html__("Yes, please", "pointfindert2d") => 'yes')
					)
			...
			vc_map( array(
				...
				"params" => array(
						...
						array(
						  ...
						  "heading" => esc_html__("Default Listing Columns", "pointfindert2d"),
						  "param_name" => "cols",
						  "value" => array('4 Columns'=>'4','3 Columns'=>'3','2 Columns'=>'2','1 Columns'=>'1'),
						  "edit_field_class" => 'vc_col-sm-4 vc_column'		  
						),
						array(
						  "type" => "dropdown",
						...
						array(
						  ...
						  "value" => array('4'=>'4','3'=>'3','2'=>'2','1'=>'1','5'=>'5','6'=>'6','7'=>'7','8'=>'8','9'=>'9','10'=>'10'),
						  "edit_field_class" => 'vc_col-sm-4 vc_column'		  
						),
						array(
							"type" => "checkbox",
