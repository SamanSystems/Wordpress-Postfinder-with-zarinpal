...
// Custom Fields --------------------------------------------------------------------------------------------------
	...
	add_shortcode_param('pfa_select1', 'pfextendvc_select1');
	...
	add_shortcode_param('pfa_numeric', 'pfextendvc_numeric1');
	...
	add_shortcode_param('pfa_select2', 'pfextendvc_select2');
	...
	add_shortcode_param('pfa_select3', 'pfextendvc_select3');
	...
	add_shortcode_param('pfa_showimg', 'pfextendvc_showimg');
	...
	add_shortcode_param('pf_info_field', 'pf_info_vc_field');
	...
	add_shortcode_param('pf_info_line_field', 'pf_info_line_vc_field');



	// PF Custom Points
	function pf_custom_points_funct($settings, $value) {
	    if (empty($value)) {
	    	$rownum = 1;
 	    	$value = 0;
	    }else{
		...
		(function($) {
			"use strict";
				...
				$.PFCloneDiv = function(rownum){
					return \'<div class="mappoint"><h3><a href="#">Point \'+rownum+\'</a></h3><div class=""><div class="vc_col-sm-6 wpb_el_type_textfield vc_shortcode-param"><div class="wpb_element_label">Point Latitude</div><div class="edit_form_line"><input name="cmap_lat[\'+rownum+\']" class="wpb_vc_param_value wpb-textinput cmap_lat textfield" type="text" value=""><span class="vc_description vc_clearfix"><a href="http://universimmedia.pagesperso-orange.fr/geo/loc.htm" target="_blank">Please click here for finding your coordinates</a></span></div></div><div class="vc_col-sm-6 vc_column wpb_el_type_textfield vc_shortcode-param"><div class="wpb_element_label">Point Longitude</div><div class="edit_form_line"><input name="cmap_lng[\'+rownum+\']" class="wpb_vc_param_value wpb-textinput cmap_lng textfield" type="text" value=""></div></div><div class="vc_col-sm-12 vc_column wpb_el_type_textfield vc_shortcode-param"><div class="wpb_element_label">Point Title</div><div class="edit_form_line"><input name="cmap_title[\'+rownum+\']" class="wpb_vc_param_value wpb-textinput cmap_title textfield" type="text" value=""></div></div><div class="vc_col-sm-12 vc_column wpb_el_type_textarea vc_shortcode-param"><div class="wpb_element_label">Point Description</div><div class="edit_form_line"><textarea name="cmap_desc[\'+rownum+\']" class="wpb_vc_param_value wpb-textarea cmap_desc textarea"></textarea></div></div></div></div>\';
		        };
	...
	add_shortcode_param('pf_custom_points', 'pf_custom_points_funct');
