...
function pf_dlist_widget_func( $atts ) {
	...
	switch ($cols) {
		case 4:
			$cols_output = 'col-lg-3 col-md-4 col-sm-6';
			break;
		case 3:
			$cols_output = 'col-lg-4 col-md-4 col-sm-6';
			break;
		case 2:
			$cols_output = 'col-lg-6 col-md-6 col-sm-6';
			break;
		case 1:
	...
	if ( ! empty( $listing_terms ) && ! is_wp_error( $listing_terms ) ) {
	    ...
	    $i = 0;
	    //$term_list ='<div class="pf-container">';
	    $term_list = '<ul class="pointfinder-terms-archive pf-row">';
		    foreach ( $listing_terms as $term ) {
		        if ($term->parent == 0) {
		        	...
		        	$term_list .= '<li class="'.$cols_output.' pf-main-term"'.$style_text_main.'>';
