			                        ...
			                        if (PFREVSIssetControl('setup11_reviewsystem_check','','0') == 1) {
			                        	if ($setup22_searchresults_hide_re == 0) {
			                        		...
			                        		if (!empty($reviews['totalresult'])) {
			                        			...
			                        			$wpflistdata_output .= ' <div class="pfrevstars-review"> <span class="hidden-xs hidden-sm">'.PFREVSIssetControl('setup16_reviewstars_revtextbefore','','').'</span>';
