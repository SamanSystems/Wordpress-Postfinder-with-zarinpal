					...
					if($HideTitleValue == 1){
						...
						if(PFControlEmptyArr($ParentItem)){
							...
							if(PFControlEmptyArr($FieldListingTax)){
								...
								if(in_array($FieldListingTax['0']->term_id, $ParentItem) ){					
										...
										if($pfsys == NULL){
											...
											*/
											if ($linkoption == 0) {
												...
												$FieldValue = '<li>'.$FieldTitle .'<a href="'.$link_addon. $SourceFieldValue.'" '.$link_target.'>'. $SourceFieldValue.'</a><span class="pf-fieldspace"></span></li>';
											}
										}elseif($pfsys == 1){
											/*
											* Changed with v1.0.6
											*/
											if ($linkoption == 0) {
												...
												$FieldValue = ''.$FieldTitle .'<span class="pf-ftext"><a href="'.$link_addon. $SourceFieldValue.'" '.$link_target.'>'. $SourceFieldValue.'</a></span></div> ';
											}
										}elseif($pfsys == 2){
											if ($linkoption == 0) {
												$FieldValue = ''.$FieldTitle .'<span class="pfdetail-ftext">'. $SourceFieldValue.'</span></div> ';
											}else{
												$FieldValue = ''.$FieldTitle .'<span class="pfdetail-ftext"><a href="'.$link_addon. $SourceFieldValue.'" '.$link_target.'>'. $SourceFieldValue.'</a></span></div> ';
											}
										}
									}
